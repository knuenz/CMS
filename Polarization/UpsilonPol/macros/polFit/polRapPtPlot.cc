...
void PlotRapPt(int ptBinMin, int ptBinMax, int rapBin, double yMin, double yMax, char yAxisTitle[200], char filename[200], double lmean[ToyMC::nPtBins], double lmeanerr[ToyMC::nPtBins], bool DrawLine, double lamline){
	...
	pt++;
 	...
 	TGraphAsymmErrors *plotGraph = new TGraphAsymmErrors(nBinspT,ptCentre_,lmean,ptCentreErr_low,ptCentreErr_high,lmeanerr,lmeanerr);
...
void PlotComparisonRapPt(int ptBinMin, int ptBinMax, int rapBin, double yMin, double yMax, char yAxisTitle[200], char filename[200], double lmean1[ToyMC::nPtBins], double lmean1err[ToyMC::nPtBins], double lmean2[ToyMC::nPtBins], double lmean2err[ToyMC::nPtBins], double lmean3[ToyMC::nPtBins], double lmean3err[ToyMC::nPtBins], double lamline){
	...
	TGraphAsymmErrors *plotGraph = new TGraphAsymmErrors(nBinspT,ptCentre_,lmean1,ptCentreErr_low,ptCentreErr_high,lmean1err,lmean1err);
	...
	pt++;
 	...
 	plotGraph = new TGraphAsymmErrors(nBinspT,ptCentre_,lmean2,ptCentreErr_low,ptCentreErr_high,lmean2err,lmean2err);
	...
	pt++;
 	...
 	plotGraph = new TGraphAsymmErrors(nBinspT,ptCentre_,lmean3,ptCentreErr_low,ptCentreErr_high,lmean3err,lmean3err);
...
///////////////////// End of Extraction ////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  if(nGen_[rap-1][pt-1]==0) {emptyBin[rap-1][pt-1]=true; cout<<"empty bin"<<endl;}
	    ...
	    param_lth_CS_mean[rap-1][pt-1]=param_lth_CS->GetMean(); param_lth_CS_meanerr[rap-1][pt-1]=param_lth_CS->GetMeanError(); param_lth_CS_sigma[rap-1][pt-1]=param_lth_CS->GetRMS(); param_lth_CS_sigmaerr[rap-1][pt-1]=param_lth_CS->GetRMSError();										if(RealData) {param_lth_CS_mean[rap-1][pt-1]=lth_CS; param_lth_CS_sigma[rap-1][pt-1]=err_lth_CS;        }
	    param_lph_CS_mean[rap-1][pt-1]=param_lph_CS->GetMean(); param_lph_CS_meanerr[rap-1][pt-1]=param_lph_CS->GetMeanError(); param_lph_CS_sigma[rap-1][pt-1]=param_lph_CS->GetRMS(); param_lph_CS_sigmaerr[rap-1][pt-1]=param_lph_CS->GetRMSError();										if(RealData) {param_lph_CS_mean[rap-1][pt-1]=lph_CS; param_lph_CS_sigma[rap-1][pt-1]=err_lph_CS;        }
	    param_ltp_CS_mean[rap-1][pt-1]=param_ltp_CS->GetMean(); param_ltp_CS_meanerr[rap-1][pt-1]=param_ltp_CS->GetMeanError(); param_ltp_CS_sigma[rap-1][pt-1]=param_ltp_CS->GetRMS(); param_ltp_CS_sigmaerr[rap-1][pt-1]=param_ltp_CS->GetRMSError();										if(RealData) {param_ltp_CS_mean[rap-1][pt-1]=ltp_CS; param_ltp_CS_sigma[rap-1][pt-1]=err_ltp_CS;        }
	    param_lthstar_CS_mean[rap-1][pt-1]=param_lthstar_CS->GetMean(); param_lthstar_CS_meanerr[rap-1][pt-1]=param_lthstar_CS->GetMeanError(); param_lthstar_CS_sigma[rap-1][pt-1]=param_lthstar_CS->GetRMS(); param_lthstar_CS_sigmaerr[rap-1][pt-1]=param_lthstar_CS->GetRMSError();		if(RealData) {param_lthstar_CS_mean[rap-1][pt-1]=lthstar_CS; param_lthstar_CS_sigma[rap-1][pt-1]=err_lthstar_CS;}
	    param_lphstar_CS_mean[rap-1][pt-1]=param_lphstar_CS->GetMean(); param_lphstar_CS_meanerr[rap-1][pt-1]=param_lphstar_CS->GetMeanError(); param_lphstar_CS_sigma[rap-1][pt-1]=param_lphstar_CS->GetRMS(); param_lphstar_CS_sigmaerr[rap-1][pt-1]=param_lphstar_CS->GetRMSError();		if(RealData) {param_lphstar_CS_mean[rap-1][pt-1]=lphstar_CS; param_lphstar_CS_sigma[rap-1][pt-1]=err_lphstar_CS;}
	    param_ltilde_CS_mean[rap-1][pt-1]=param_ltilde_CS->GetMean(); param_ltilde_CS_meanerr[rap-1][pt-1]=param_ltilde_CS->GetMeanError(); param_ltilde_CS_sigma[rap-1][pt-1]=param_ltilde_CS->GetRMS(); param_ltilde_CS_sigmaerr[rap-1][pt-1]=param_ltilde_CS->GetRMSError();				if(RealData) {param_ltilde_CS_mean[rap-1][pt-1]=ltilde_CS; param_ltilde_CS_sigma[rap-1][pt-1]=err_ltilde_CS;  }

	    param_lth_HX_mean[rap-1][pt-1]=param_lth_HX->GetMean(); param_lth_HX_meanerr[rap-1][pt-1]=param_lth_HX->GetMeanError(); param_lth_HX_sigma[rap-1][pt-1]=param_lth_HX->GetRMS(); param_lth_HX_sigmaerr[rap-1][pt-1]=param_lth_HX->GetRMSError();										if(RealData) {param_lth_HX_mean[rap-1][pt-1]=lth_HX; param_lth_HX_sigma[rap-1][pt-1]=err_lth_HX;        }
	    param_lph_HX_mean[rap-1][pt-1]=param_lph_HX->GetMean(); param_lph_HX_meanerr[rap-1][pt-1]=param_lph_HX->GetMeanError(); param_lph_HX_sigma[rap-1][pt-1]=param_lph_HX->GetRMS(); param_lph_HX_sigmaerr[rap-1][pt-1]=param_lph_HX->GetRMSError();										if(RealData) {param_lph_HX_mean[rap-1][pt-1]=lph_HX; param_lph_HX_sigma[rap-1][pt-1]=err_lph_HX;        }
	    param_ltp_HX_mean[rap-1][pt-1]=param_ltp_HX->GetMean(); param_ltp_HX_meanerr[rap-1][pt-1]=param_ltp_HX->GetMeanError(); param_ltp_HX_sigma[rap-1][pt-1]=param_ltp_HX->GetRMS(); param_ltp_HX_sigmaerr[rap-1][pt-1]=param_ltp_HX->GetRMSError();										if(RealData) {param_ltp_HX_mean[rap-1][pt-1]=ltp_HX; param_ltp_HX_sigma[rap-1][pt-1]=err_ltp_HX;        }
	    param_lthstar_HX_mean[rap-1][pt-1]=param_lthstar_HX->GetMean(); param_lthstar_HX_meanerr[rap-1][pt-1]=param_lthstar_HX->GetMeanError(); param_lthstar_HX_sigma[rap-1][pt-1]=param_lthstar_HX->GetRMS(); param_lthstar_HX_sigmaerr[rap-1][pt-1]=param_lthstar_HX->GetRMSError();		if(RealData) {param_lthstar_HX_mean[rap-1][pt-1]=lthstar_HX; param_lthstar_HX_sigma[rap-1][pt-1]=err_lthstar_HX;}
	    param_lphstar_HX_mean[rap-1][pt-1]=param_lphstar_HX->GetMean(); param_lphstar_HX_meanerr[rap-1][pt-1]=param_lphstar_HX->GetMeanError(); param_lphstar_HX_sigma[rap-1][pt-1]=param_lphstar_HX->GetRMS(); param_lphstar_HX_sigmaerr[rap-1][pt-1]=param_lphstar_HX->GetRMSError();		if(RealData) {param_lphstar_HX_mean[rap-1][pt-1]=lphstar_HX; param_lphstar_HX_sigma[rap-1][pt-1]=err_lphstar_HX;}
	    param_ltilde_HX_mean[rap-1][pt-1]=param_ltilde_HX->GetMean(); param_ltilde_HX_meanerr[rap-1][pt-1]=param_ltilde_HX->GetMeanError(); param_ltilde_HX_sigma[rap-1][pt-1]=param_ltilde_HX->GetRMS(); param_ltilde_HX_sigmaerr[rap-1][pt-1]=param_ltilde_HX->GetRMSError();				if(RealData) {param_ltilde_HX_mean[rap-1][pt-1]=ltilde_HX; param_ltilde_HX_sigma[rap-1][pt-1]=err_ltilde_HX;  }

	    param_lth_PX_mean[rap-1][pt-1]=param_lth_PX->GetMean(); param_lth_PX_meanerr[rap-1][pt-1]=param_lth_PX->GetMeanError(); param_lth_PX_sigma[rap-1][pt-1]=param_lth_PX->GetRMS(); param_lth_PX_sigmaerr[rap-1][pt-1]=param_lth_PX->GetRMSError();										if(RealData) {param_lth_PX_mean[rap-1][pt-1]=lth_PX; param_lth_PX_sigma[rap-1][pt-1]=err_lth_PX;        }
	    param_lph_PX_mean[rap-1][pt-1]=param_lph_PX->GetMean(); param_lph_PX_meanerr[rap-1][pt-1]=param_lph_PX->GetMeanError(); param_lph_PX_sigma[rap-1][pt-1]=param_lph_PX->GetRMS(); param_lph_PX_sigmaerr[rap-1][pt-1]=param_lph_PX->GetRMSError();										if(RealData) {param_lph_PX_mean[rap-1][pt-1]=lph_PX; param_lph_PX_sigma[rap-1][pt-1]=err_lph_PX;        }
	    param_ltp_PX_mean[rap-1][pt-1]=param_ltp_PX->GetMean(); param_ltp_PX_meanerr[rap-1][pt-1]=param_ltp_PX->GetMeanError(); param_ltp_PX_sigma[rap-1][pt-1]=param_ltp_PX->GetRMS(); param_ltp_PX_sigmaerr[rap-1][pt-1]=param_ltp_PX->GetRMSError();										if(RealData) {param_ltp_PX_mean[rap-1][pt-1]=ltp_PX; param_ltp_PX_sigma[rap-1][pt-1]=err_ltp_PX;        }
	    param_lthstar_PX_mean[rap-1][pt-1]=param_lthstar_PX->GetMean(); param_lthstar_PX_meanerr[rap-1][pt-1]=param_lthstar_PX->GetMeanError(); param_lthstar_PX_sigma[rap-1][pt-1]=param_lthstar_PX->GetRMS(); param_lthstar_PX_sigmaerr[rap-1][pt-1]=param_lthstar_PX->GetRMSError();		if(RealData) {param_lthstar_PX_mean[rap-1][pt-1]=lthstar_PX; param_lthstar_PX_sigma[rap-1][pt-1]=err_lthstar_PX;}
	    param_lphstar_PX_mean[rap-1][pt-1]=param_lphstar_PX->GetMean(); param_lphstar_PX_meanerr[rap-1][pt-1]=param_lphstar_PX->GetMeanError(); param_lphstar_PX_sigma[rap-1][pt-1]=param_lphstar_PX->GetRMS(); param_lphstar_PX_sigmaerr[rap-1][pt-1]=param_lphstar_PX->GetRMSError();		if(RealData) {param_lphstar_PX_mean[rap-1][pt-1]=lphstar_PX; param_lphstar_PX_sigma[rap-1][pt-1]=err_lphstar_PX;}
	    param_ltilde_PX_mean[rap-1][pt-1]=param_ltilde_PX->GetMean(); param_ltilde_PX_meanerr[rap-1][pt-1]=param_ltilde_PX->GetMeanError(); param_ltilde_PX_sigma[rap-1][pt-1]=param_ltilde_PX->GetRMS(); param_ltilde_PX_sigmaerr[rap-1][pt-1]=param_ltilde_PX->GetRMSError();				if(RealData) {param_ltilde_PX_mean[rap-1][pt-1]=ltilde_PX; param_ltilde_PX_sigma[rap-1][pt-1]=err_ltilde_PX;  }
...
//////// Rap/Pt Summary Plots ////////////////
	    ...
	    for(int rapBin = rapBinMin; rapBin < rapBinMax+1; rapBin++) {
	    	...
	    	if(iLam==23){lammin=dmumin;		lammax=dmumax;	if(polScen==6){lammin=lammin+2;lammax=lammax+2;}sprintf(filename,"%s/Figures/KinDep_param_CS_mean_ltilde_rap%d.pdf",dirstruct,rapBin); 		sprintf(axislabel,"#tilde{#lambda}^{CS}");}
	    	...
	    	if(iLam==35){lammin=dmumin;		lammax=dmumax;	if(polScen==6){lammin=lammin+2;lammax=lammax+2;}sprintf(filename,"%s/Figures/KinDep_param_HX_mean_ltilde_rap%d.pdf",dirstruct,rapBin); 		sprintf(axislabel,"#tilde{#lambda}^{HX}");}
	    	...
	    	if(iLam==47){lammin=dmumin;		lammax=dmumax;	if(polScen==6){lammin=lammin+2;lammax=lammax+2;}sprintf(filename,"%s/Figures/KinDep_param_PX_mean_ltilde_rap%d.pdf",dirstruct,rapBin); 		sprintf(axislabel,"#tilde{#lambda}^{PX}");}
	    	...
	    	if(iLam==103){lammin=ddeltamumin;	lammax=ddeltamumax;	if(polScen==6){lammin=lammin+2;lammax=lammax+2;}sprintf(filename,"%s/Figures/KinDep_param_mean_Comparison_ltilde_rap%d.pdf",dirstruct,rapBin); 		sprintf(axislabel,"#tilde{#lambda}"); lamline=lambda_tilde_injected_CS[rapBin-1][0];}
	    	if(iLam==104){lammin=ddeltamumin;	lammax=ddeltamumax;	sprintf(filename,"%s/Figures/KinDep_param_mean_Comparison_lthstar_rap%d.pdf",dirstruct,rapBin); 	sprintf(axislabel,"#lambda*_{#theta}"); lamline=lambda_thetastar_injected_CS[rapBin-1][0];}
	    	if(iLam==105){lammin=ddeltamumin;	lammax=ddeltamumax;	sprintf(filename,"%s/Figures/KinDep_param_mean_Comparison_lphstar_rap%d.pdf",dirstruct,rapBin); 	sprintf(axislabel,"#lambda*_{#phi}"); lamline=lambda_phistar_injected_CS[rapBin-1][0];}
					...
					for(int ptBin = ptBinMin; ptBin < ptBinMax+1; ptBin++) {
						...
						if(iLam==13){ KinDepRap[pt]= param_lth_CS_mean[rap][pt]; 		KinDepRaperr[pt]=param_lth_CS_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_lth_CS_sigma[rap][pt];}
						if(iLam==14){ KinDepRap[pt]= param_lth_CS_sigma[rap][pt]; 		KinDepRaperr[pt]=param_lth_CS_sigmaerr[rap][pt];}
						if(iLam==15){ KinDepRap[pt]= param_lph_CS_mean[rap][pt]; 		KinDepRaperr[pt]=param_lph_CS_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_lph_CS_sigma[rap][pt];}
						if(iLam==16){ KinDepRap[pt]= param_lph_CS_sigma[rap][pt]; 		KinDepRaperr[pt]=param_lph_CS_sigmaerr[rap][pt];}
						if(iLam==17){ KinDepRap[pt]= param_ltp_CS_mean[rap][pt]; 		KinDepRaperr[pt]=param_ltp_CS_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_ltp_CS_sigma[rap][pt];}
						if(iLam==18){ KinDepRap[pt]= param_ltp_CS_sigma[rap][pt]; 		KinDepRaperr[pt]=param_ltp_CS_sigmaerr[rap][pt];}
						if(iLam==19){ KinDepRap[pt]= param_lthstar_CS_mean[rap][pt]; 	KinDepRaperr[pt]=param_lthstar_CS_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_lthstar_CS_sigma[rap][pt];}
						if(iLam==20){ KinDepRap[pt]= param_lthstar_CS_sigma[rap][pt]; 	KinDepRaperr[pt]=param_lthstar_CS_sigmaerr[rap][pt];}
						if(iLam==21){ KinDepRap[pt]= param_lphstar_CS_mean[rap][pt]; 	KinDepRaperr[pt]=param_lphstar_CS_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_lphstar_CS_sigma[rap][pt];}
						if(iLam==22){ KinDepRap[pt]= param_lphstar_CS_sigma[rap][pt]; 	KinDepRaperr[pt]=param_lphstar_CS_sigmaerr[rap][pt];}
						if(iLam==23){ KinDepRap[pt]= param_ltilde_CS_mean[rap][pt]; 	KinDepRaperr[pt]=param_ltilde_CS_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_ltilde_CS_sigma[rap][pt];}
						if(iLam==24){ KinDepRap[pt]= param_ltilde_CS_sigma[rap][pt]; 	KinDepRaperr[pt]=param_ltilde_CS_sigmaerr[rap][pt];}

						if(iLam==25){ KinDepRap[pt]= param_lth_HX_mean[rap][pt]; 		KinDepRaperr[pt]=param_lth_HX_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_lth_HX_sigma[rap][pt];}
						if(iLam==26){ KinDepRap[pt]= param_lth_HX_sigma[rap][pt]; 		KinDepRaperr[pt]=param_lth_HX_sigmaerr[rap][pt];}
						if(iLam==27){ KinDepRap[pt]= param_lph_HX_mean[rap][pt]; 		KinDepRaperr[pt]=param_lph_HX_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_lph_HX_sigma[rap][pt];}
						if(iLam==28){ KinDepRap[pt]= param_lph_HX_sigma[rap][pt]; 		KinDepRaperr[pt]=param_lph_HX_sigmaerr[rap][pt];}
						if(iLam==29){ KinDepRap[pt]= param_ltp_HX_mean[rap][pt]; 		KinDepRaperr[pt]=param_ltp_HX_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_ltp_HX_sigma[rap][pt];}
						if(iLam==30){ KinDepRap[pt]= param_ltp_HX_sigma[rap][pt]; 		KinDepRaperr[pt]=param_ltp_HX_sigmaerr[rap][pt];}
						if(iLam==31){ KinDepRap[pt]= param_lthstar_HX_mean[rap][pt]; 	KinDepRaperr[pt]=param_lthstar_HX_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_lthstar_HX_sigma[rap][pt];}
						if(iLam==32){ KinDepRap[pt]= param_lthstar_HX_sigma[rap][pt]; 	KinDepRaperr[pt]=param_lthstar_HX_sigmaerr[rap][pt];}
						if(iLam==33){ KinDepRap[pt]= param_lphstar_HX_mean[rap][pt]; 	KinDepRaperr[pt]=param_lphstar_HX_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_lphstar_HX_sigma[rap][pt];}
						if(iLam==34){ KinDepRap[pt]= param_lphstar_HX_sigma[rap][pt]; 	KinDepRaperr[pt]=param_lphstar_HX_sigmaerr[rap][pt];}
						if(iLam==35){ KinDepRap[pt]= param_ltilde_HX_mean[rap][pt]; 	KinDepRaperr[pt]=param_ltilde_HX_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_ltilde_HX_sigma[rap][pt];}
						if(iLam==36){ KinDepRap[pt]= param_ltilde_HX_sigma[rap][pt]; 	KinDepRaperr[pt]=param_ltilde_HX_sigmaerr[rap][pt];}

						if(iLam==37){ KinDepRap[pt]= param_lth_PX_mean[rap][pt]; 		KinDepRaperr[pt]=param_lth_PX_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_lth_PX_sigma[rap][pt];}
						if(iLam==38){ KinDepRap[pt]= param_lth_PX_sigma[rap][pt]; 		KinDepRaperr[pt]=param_lth_PX_sigmaerr[rap][pt];}
						if(iLam==39){ KinDepRap[pt]= param_lph_PX_mean[rap][pt]; 		KinDepRaperr[pt]=param_lph_PX_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_lph_PX_sigma[rap][pt];}
						if(iLam==40){ KinDepRap[pt]= param_lph_PX_sigma[rap][pt]; 		KinDepRaperr[pt]=param_lph_PX_sigmaerr[rap][pt];}
						if(iLam==41){ KinDepRap[pt]= param_ltp_PX_mean[rap][pt]; 		KinDepRaperr[pt]=param_ltp_PX_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_ltp_PX_sigma[rap][pt];}
						if(iLam==42){ KinDepRap[pt]= param_ltp_PX_sigma[rap][pt]; 		KinDepRaperr[pt]=param_ltp_PX_sigmaerr[rap][pt];}
						if(iLam==43){ KinDepRap[pt]= param_lthstar_PX_mean[rap][pt]; 	KinDepRaperr[pt]=param_lthstar_PX_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_lthstar_PX_sigma[rap][pt];}
						if(iLam==44){ KinDepRap[pt]= param_lthstar_PX_sigma[rap][pt]; 	KinDepRaperr[pt]=param_lthstar_PX_sigmaerr[rap][pt];}
						if(iLam==45){ KinDepRap[pt]= param_lphstar_PX_mean[rap][pt]; 	KinDepRaperr[pt]=param_lphstar_PX_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_lphstar_PX_sigma[rap][pt];}
						if(iLam==46){ KinDepRap[pt]= param_lphstar_PX_sigma[rap][pt]; 	KinDepRaperr[pt]=param_lphstar_PX_sigmaerr[rap][pt];}
						if(iLam==47){ KinDepRap[pt]= param_ltilde_PX_mean[rap][pt]; 	KinDepRaperr[pt]=param_ltilde_PX_meanerr[rap][pt]; if(RealData) KinDepRaperr[pt]= param_ltilde_PX_sigma[rap][pt];}
		    	...
		    	if(iFrame==3) {sprintf(framerap,"\\hline \\multicolumn{7}{|c|}{PX frame, $%1.1f < |y| < %1.1f$}\\\\ \\hline \\rule{0pt}{4mm}\n",onia::rapForPTRange[rapBin-1],onia::rapForPTRange[rapBin]); fprintf(NumFile,framerap);}
					...
					int pt=0;
						for(int ptBin = ptBinMin; ptBin < ptBinMax+1; ptBin++) {
							...
							if(iTab==1){
								if(iFrame==1){
									lth_tab=param_lth_CS_mean[rap][pt]			;   ltherr_tab=param_lth_CS_sigma[rap][pt];
									lph_tab=param_lph_CS_mean[rap][pt]			;   lpherr_tab=param_lph_CS_sigma[rap][pt];
									ltp_tab=param_ltp_CS_mean[rap][pt]			;   ltperr_tab=param_ltp_CS_sigma[rap][pt];
									ltilde_tab=param_ltilde_CS_mean[rap][pt]	;   ltildeerr_tab=param_ltilde_CS_sigma[rap][pt];
									lthstar_tab=param_lthstar_CS_mean[rap][pt]	;   lthstarerr_tab=param_lthstar_CS_sigma[rap][pt];
									lphstar_tab=param_lphstar_CS_mean[rap][pt]	;   lphstarerr_tab=param_lphstar_CS_sigma[rap][pt];
								}                                               ;
								if(iFrame==2){                                  ;
									lth_tab=param_lth_HX_mean[rap][pt]			;   ltherr_tab=param_lth_HX_sigma[rap][pt];
									lph_tab=param_lph_HX_mean[rap][pt]			;   lpherr_tab=param_lph_HX_sigma[rap][pt];
									ltp_tab=param_ltp_HX_mean[rap][pt]			;   ltperr_tab=param_ltp_HX_sigma[rap][pt];
									ltilde_tab=param_ltilde_HX_mean[rap][pt]	;   ltildeerr_tab=param_ltilde_HX_sigma[rap][pt];
									lthstar_tab=param_lthstar_HX_mean[rap][pt]	;   lthstarerr_tab=param_lthstar_HX_sigma[rap][pt];
									lphstar_tab=param_lphstar_HX_mean[rap][pt]	;   lphstarerr_tab=param_lphstar_HX_sigma[rap][pt];
								}                                               ;
								if(iFrame==3){                                  ;
									lth_tab=param_lth_PX_mean[rap][pt]			;   ltherr_tab=param_lth_PX_sigma[rap][pt];
									lph_tab=param_lph_PX_mean[rap][pt]			;   lpherr_tab=param_lph_PX_sigma[rap][pt];
									ltp_tab=param_ltp_PX_mean[rap][pt]			;   ltperr_tab=param_ltp_PX_sigma[rap][pt];
									ltilde_tab=param_ltilde_PX_mean[rap][pt]	;   ltildeerr_tab=param_ltilde_PX_sigma[rap][pt];
									lthstar_tab=param_lthstar_PX_mean[rap][pt]	;   lthstarerr_tab=param_lthstar_PX_sigma[rap][pt];
									lphstar_tab=param_lphstar_PX_mean[rap][pt]	;   lphstarerr_tab=param_lphstar_PX_sigma[rap][pt];
								}
							}

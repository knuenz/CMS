...
///////////////////// End of Extraction ////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  if(nGen_[rap-1][pt-1]==0) {emptyBin[rap-1][pt-1]=true; cout<<"empty bin"<<endl;}
	    ...
	    param_lth_CS_mean[rap-1][pt-1]=param_lth_CS->GetMean(); param_lth_CS_meanerr[rap-1][pt-1]=param_lth_CS->GetMeanError(); param_lth_CS_sigma[rap-1][pt-1]=param_lth_CS->GetRMS(); param_lth_CS_sigmaerr[rap-1][pt-1]=param_lth_CS->GetRMSError();										if(RealData) param_lth_CS_sigma[rap-1][pt-1]=err_lth_CS;
	    param_lph_CS_mean[rap-1][pt-1]=param_lph_CS->GetMean(); param_lph_CS_meanerr[rap-1][pt-1]=param_lph_CS->GetMeanError(); param_lph_CS_sigma[rap-1][pt-1]=param_lph_CS->GetRMS(); param_lph_CS_sigmaerr[rap-1][pt-1]=param_lph_CS->GetRMSError();										if(RealData) param_lph_CS_sigma[rap-1][pt-1]=err_lph_CS;
	    param_ltp_CS_mean[rap-1][pt-1]=param_ltp_CS->GetMean(); param_ltp_CS_meanerr[rap-1][pt-1]=param_ltp_CS->GetMeanError(); param_ltp_CS_sigma[rap-1][pt-1]=param_ltp_CS->GetRMS(); param_ltp_CS_sigmaerr[rap-1][pt-1]=param_ltp_CS->GetRMSError();										if(RealData) param_ltp_CS_sigma[rap-1][pt-1]=err_ltp_CS;
	    param_lthstar_CS_mean[rap-1][pt-1]=param_lthstar_CS->GetMean(); param_lthstar_CS_meanerr[rap-1][pt-1]=param_lthstar_CS->GetMeanError(); param_lthstar_CS_sigma[rap-1][pt-1]=param_lthstar_CS->GetRMS(); param_lthstar_CS_sigmaerr[rap-1][pt-1]=param_lthstar_CS->GetRMSError();		if(RealData) param_lthstar_CS_sigma[rap-1][pt-1]=err_lthstar_CS;
	    param_lphstar_CS_mean[rap-1][pt-1]=param_lphstar_CS->GetMean(); param_lphstar_CS_meanerr[rap-1][pt-1]=param_lphstar_CS->GetMeanError(); param_lphstar_CS_sigma[rap-1][pt-1]=param_lphstar_CS->GetRMS(); param_lphstar_CS_sigmaerr[rap-1][pt-1]=param_lphstar_CS->GetRMSError();		if(RealData) param_lphstar_CS_sigma[rap-1][pt-1]=err_lphstar_CS;
	    param_ltilde_CS_mean[rap-1][pt-1]=param_ltilde_CS->GetMean(); param_ltilde_CS_meanerr[rap-1][pt-1]=param_ltilde_CS->GetMeanError(); param_ltilde_CS_sigma[rap-1][pt-1]=param_ltilde_CS->GetRMS(); param_ltilde_CS_sigmaerr[rap-1][pt-1]=param_ltilde_CS->GetRMSError();				if(RealData) param_ltilde_CS_sigma[rap-1][pt-1]=err_ltilde_CS;

	    param_lth_HX_mean[rap-1][pt-1]=param_lth_HX->GetMean(); param_lth_HX_meanerr[rap-1][pt-1]=param_lth_HX->GetMeanError(); param_lth_HX_sigma[rap-1][pt-1]=param_lth_HX->GetRMS(); param_lth_HX_sigmaerr[rap-1][pt-1]=param_lth_HX->GetRMSError();										if(RealData) param_lth_HX_sigma[rap-1][pt-1]=err_lth_HX;
	    param_lph_HX_mean[rap-1][pt-1]=param_lph_HX->GetMean(); param_lph_HX_meanerr[rap-1][pt-1]=param_lph_HX->GetMeanError(); param_lph_HX_sigma[rap-1][pt-1]=param_lph_HX->GetRMS(); param_lph_HX_sigmaerr[rap-1][pt-1]=param_lph_HX->GetRMSError();										if(RealData) param_lph_HX_sigma[rap-1][pt-1]=err_lph_HX;
	    param_ltp_HX_mean[rap-1][pt-1]=param_ltp_HX->GetMean(); param_ltp_HX_meanerr[rap-1][pt-1]=param_ltp_HX->GetMeanError(); param_ltp_HX_sigma[rap-1][pt-1]=param_ltp_HX->GetRMS(); param_ltp_HX_sigmaerr[rap-1][pt-1]=param_ltp_HX->GetRMSError();										if(RealData) param_ltp_HX_sigma[rap-1][pt-1]=err_ltp_HX;
	    param_lthstar_HX_mean[rap-1][pt-1]=param_lthstar_HX->GetMean(); param_lthstar_HX_meanerr[rap-1][pt-1]=param_lthstar_HX->GetMeanError(); param_lthstar_HX_sigma[rap-1][pt-1]=param_lthstar_HX->GetRMS(); param_lthstar_HX_sigmaerr[rap-1][pt-1]=param_lthstar_HX->GetRMSError();		if(RealData) param_lthstar_HX_sigma[rap-1][pt-1]=err_lthstar_HX;
	    param_lphstar_HX_mean[rap-1][pt-1]=param_lphstar_HX->GetMean(); param_lphstar_HX_meanerr[rap-1][pt-1]=param_lphstar_HX->GetMeanError(); param_lphstar_HX_sigma[rap-1][pt-1]=param_lphstar_HX->GetRMS(); param_lphstar_HX_sigmaerr[rap-1][pt-1]=param_lphstar_HX->GetRMSError();		if(RealData) param_lphstar_HX_sigma[rap-1][pt-1]=err_lphstar_HX;
	    param_ltilde_HX_mean[rap-1][pt-1]=param_ltilde_HX->GetMean(); param_ltilde_HX_meanerr[rap-1][pt-1]=param_ltilde_HX->GetMeanError(); param_ltilde_HX_sigma[rap-1][pt-1]=param_ltilde_HX->GetRMS(); param_ltilde_HX_sigmaerr[rap-1][pt-1]=param_ltilde_HX->GetRMSError();				if(RealData) param_ltilde_HX_sigma[rap-1][pt-1]=err_ltilde_HX;

	    param_lth_PX_mean[rap-1][pt-1]=param_lth_PX->GetMean(); param_lth_PX_meanerr[rap-1][pt-1]=param_lth_PX->GetMeanError(); param_lth_PX_sigma[rap-1][pt-1]=param_lth_PX->GetRMS(); param_lth_PX_sigmaerr[rap-1][pt-1]=param_lth_PX->GetRMSError();										if(RealData) param_lth_PX_sigma[rap-1][pt-1]=err_lth_PX;
	    param_lph_PX_mean[rap-1][pt-1]=param_lph_PX->GetMean(); param_lph_PX_meanerr[rap-1][pt-1]=param_lph_PX->GetMeanError(); param_lph_PX_sigma[rap-1][pt-1]=param_lph_PX->GetRMS(); param_lph_PX_sigmaerr[rap-1][pt-1]=param_lph_PX->GetRMSError();										if(RealData) param_lph_PX_sigma[rap-1][pt-1]=err_lph_PX;
	    param_ltp_PX_mean[rap-1][pt-1]=param_ltp_PX->GetMean(); param_ltp_PX_meanerr[rap-1][pt-1]=param_ltp_PX->GetMeanError(); param_ltp_PX_sigma[rap-1][pt-1]=param_ltp_PX->GetRMS(); param_ltp_PX_sigmaerr[rap-1][pt-1]=param_ltp_PX->GetRMSError();										if(RealData) param_ltp_PX_sigma[rap-1][pt-1]=err_ltp_PX;
	    param_lthstar_PX_mean[rap-1][pt-1]=param_lthstar_PX->GetMean(); param_lthstar_PX_meanerr[rap-1][pt-1]=param_lthstar_PX->GetMeanError(); param_lthstar_PX_sigma[rap-1][pt-1]=param_lthstar_PX->GetRMS(); param_lthstar_PX_sigmaerr[rap-1][pt-1]=param_lthstar_PX->GetRMSError();		if(RealData) param_lthstar_PX_sigma[rap-1][pt-1]=err_lthstar_PX;
	    param_lphstar_PX_mean[rap-1][pt-1]=param_lphstar_PX->GetMean(); param_lphstar_PX_meanerr[rap-1][pt-1]=param_lphstar_PX->GetMeanError(); param_lphstar_PX_sigma[rap-1][pt-1]=param_lphstar_PX->GetRMS(); param_lphstar_PX_sigmaerr[rap-1][pt-1]=param_lphstar_PX->GetRMSError();		if(RealData) param_lphstar_PX_sigma[rap-1][pt-1]=err_lphstar_PX;
	    param_ltilde_PX_mean[rap-1][pt-1]=param_ltilde_PX->GetMean(); param_ltilde_PX_meanerr[rap-1][pt-1]=param_ltilde_PX->GetMeanError(); param_ltilde_PX_sigma[rap-1][pt-1]=param_ltilde_PX->GetRMS(); param_ltilde_PX_sigmaerr[rap-1][pt-1]=param_ltilde_PX->GetRMSError();				if(RealData) param_ltilde_PX_sigma[rap-1][pt-1]=err_ltilde_PX;

...
Char_t *fileNameData = "/scratch/knuenz/Polarization/RootInput/TNtuple_red_LambdaBerr.root";
Char_t *fileNamepseudoData = "/scratch/knuenz/Polarization/RootInput/TNtuple_red_LambdaBerr_pseudo.root";
...
//	RooDataSet* reddataset = (RooDataSet*)dataset->reduce("JpsiPt < 20 && JpsiPt > 12.5 && abs(JpsiRap) < 0.9 && abs(JpsiRap) > 0");
	...
	tree->SaveAs("/scratch/knuenz/Polarization/RootInput/TTree_red_LambdaBerr.root");
	pseudotree->SaveAs("/scratch/knuenz/Polarization/RootInput/TTree_red_LambdaBerr_pseudo.root");

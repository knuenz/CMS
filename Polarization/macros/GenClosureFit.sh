...
mv CLOSURE_${JOBNAME}_scen${scenario}_rap${rap_}_pT${pT_}_gen${generation}_CS.root ${dirstruct}ProjectClosure/${JOBNAME}/scenario${scenario}/CLOSURE_${JOBNAME}_scen${scenario}_rap${rap_}_pT${pT_}_gen${generation}_CS.root
mv CLOSURE_${JOBNAME}_scen${scenario}_rap${rap_}_pT${pT_}_gen${generation}_HX.root ${dirstruct}ProjectClosure/${JOBNAME}/scenario${scenario}/CLOSURE_${JOBNAME}_scen${scenario}_rap${rap_}_pT${pT_}_gen${generation}_HX.root
mv CLOSURE_${JOBNAME}_scen${scenario}_rap${rap_}_pT${pT_}_gen${generation}_CS-CS.root ${dirstruct}ProjectClosure/${JOBNAME}/scenario${scenario}/CLOSURE_${JOBNAME}_scen${scenario}_rap${rap_}_pT${pT_}_gen${generation}_CS-CS.root
mv CLOSURE_${JOBNAME}_scen${scenario}_rap${rap_}_pT${pT_}_gen${generation}_HX-HX.root ${dirstruct}ProjectClosure/${JOBNAME}/scenario${scenario}/CLOSURE_${JOBNAME}_scen${scenario}_rap${rap_}_pT${pT_}_gen${generation}_HX-HX.root
mv terminal_CLOSURE_${JOBNAME}_scen${scenario}_rap${rap_}_pT${pT_}_gen${generation}_CS.txt ${dirstruct}ProjectClosure/${JOBNAME}/scenario${scenario}/terminal_CLOSURE_${JOBNAME}_scen${scenario}_rap${rap_}_pT${pT_}_gen${generation}_CS.txt
mv terminal_CLOSURE_${JOBNAME}_scen${scenario}_rap${rap_}_pT${pT_}_gen${generation}_HX.txt ${dirstruct}ProjectClosure/${JOBNAME}/scenario${scenario}/terminal_CLOSURE_${JOBNAME}_scen${scenario}_rap${rap_}_pT${pT_}_gen${generation}_HX.txt

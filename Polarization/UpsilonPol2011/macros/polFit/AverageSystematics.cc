...
int main(int argc, char** argv) {
	...
	int nSystematics=1;
	  ...
	  for( int i=0;i < argc; ++i ) {
		...
		sprintf(tmpfilename,"%s/macros/polFit/Systematics/%s/AverageSyst/TGraphResults_%dSUps.root",basedir,SystID,nState);
		gSystem->Unlink(tmpfilename);

		char filename[200];
		sprintf(filename,"%s/macros/polFit/Systematics/%s/%s/TGraphResults_%dSUps.root",basedir,SystID,JobID1,nState);
		TFile *infile1 = new TFile(filename,"READ");
		sprintf(filename,"%s/macros/polFit/Systematics/%s/%s/TGraphResults_%dSUps.root",basedir,SystID,JobID2,nState);
		TFile *infile2 = new TFile(filename,"READ");
		sprintf(filename,"%s/macros/polFit/Systematics/%s/%s/TGraphResults_%dSUps.root",basedir,SystID,JobID3,nState);
		TFile *infile3 = new TFile(filename,"READ");
		sprintf(filename,"%s/macros/polFit/Systematics/%s/%s/TGraphResults_%dSUps.root",basedir,SystID,JobID4,nState);
		TFile *infile4 = new TFile(filename,"READ");
		sprintf(filename,"%s/macros/polFit/Systematics/%s/%s/TGraphResults_%dSUps.root",basedir,SystID,JobID5,nState);
		TFile *infile5 = new TFile(filename,"READ");
		sprintf(filename,"%s/macros/polFit/Systematics/%s/%s/TGraphResults_%dSUps.root",basedir,SystID,JobID6,nState);
		TFile *infile6 = new TFile(filename,"READ");
		sprintf(filename,"%s/macros/polFit/Systematics/%s/%s/TGraphResults_%dSUps.root",basedir,SystID,JobID7,nState);
		TFile *infile7 = new TFile(filename,"READ");
		sprintf(filename,"%s/macros/polFit/Systematics/%s/%s/TGraphResults_%dSUps.root",basedir,SystID,JobID8,nState);
		TFile *infile8 = new TFile(filename,"READ");
		sprintf(filename,"%s/macros/polFit/Systematics/%s/%s/TGraphResults_%dSUps.root",basedir,SystID,JobID9,nState);
		...
		for(int rapBin = 1; rapBin < 3; rapBin++){
			...
			sprintf(filename,"%s/macros/polFit/Systematics/%s/AverageSyst/TGraphResults_%dSUps.root",basedir,SystID,nState);

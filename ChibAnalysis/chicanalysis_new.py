...
#    inputfiles = [ 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_v13dp1_27Jan_A_2166pb.root', 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_v13dp1_27Jan_B_2576pb.root' ]
#    inputfiles = [ 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_v13dp1_conv1_dM50_10Feb_2011A_2101pb.root', 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_v13dp1_conv1_dM50_10Feb_2011B_2446pb.root' ]
    inputfiles = [ 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_v13dp1_conv1_dM50_JpsidM_11Feb_2011A_2056pb.root', 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_v13dp1_conv1_dM50_JpsidM_11Feb_2011B_2491pb.root' ]
...
#    from ROOT import IncompleteGammaComplement
    ...
    chicCand_l = ( "chic","chicCompCand" )
    
    #candidate J/Psi
    jpsiCand_h  = Handle ("vector<pat::CompositeCandidate>")
    jpsiCand_l = ( "chic","jpsiCompCand" )
    ...
    gammaCand_l = ( "chic","gammaCompCand" )
    ...
    triggerResults_h =  Handle("edm::TriggerResults")
    triggerResults_l =  ("TriggerResults","","HLT")
    ...
    Y1Smass_nSigma    = RooRealVar("Y1Smass_nSigma","Y1Smass_nSigma",-1000,1000)
    Y2Smass_nSigma    = RooRealVar("Y2Smass_nSigma","Y2Smass_nSigma",-1000,1000)
    Y3Smass_nSigma    = RooRealVar("Y3Smass_nSigma","Y3Smass_nSigma",-1000,1000)

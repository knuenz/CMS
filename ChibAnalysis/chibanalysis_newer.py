...
chi2Conv   	= RooRealVar("chi2Conv", "chi2Conv",0,1000)
...
vtxerrdz        = RooRealVar("vtxerrdz"   , "vtxerrdz"   ,  0, 5)
...
def saveHistos():
    #outdataset= TFile("chibStudy.root","recreate")
...
def fillHistos(chicCand, jpsiCand, jpsiCandPAT, gammaCand, convCand, z_tupla, nearestMass, i, nevents):
    ...
    gammaeta.setVal(0.5*TMath.Log((TMath.Sqrt(gammaCand.px()*gammaCand.px()+gammaCand.py()*gammaCand.py()+gammaCand.pz()*gammaCand.pz())+gammaCand.pz())/(TMath.Sqrt(gammaCand.px()*gammaCand.px()+gammaCand.py()*gammaCand.py()+gammaCand.pz()*gammaCand.pz())-gammaCand.pz())))
    Q.setVal(Qval)
...
def loopOnChi(args):
    ...
    for i in range(args['chicColl'].size()):
        ...
        nearestMass = pi0Cut(gammaCand,args['pfColl'])

        fillHistos(chicCand, jpsiCand, jpsiCandPAT, gammaCand, convCand, z_tupla, nearestMass, i, args['nevents'])
...
def pi0Cut(conv,pfColl):
    ...
    for pf in pfColl:
        ...
        if( abs(pi0Cand.M()-Pi0Mass) < NearestMass):
...
#    inputfiles = [ 'file:/afs/cern.ch/user/m/mahmad/public/forDomenico/03April12/chic_SelEvts_Output_Step5.root',]
#    inputfiles = [ 'file:/scratch/knuenz/Polarization/RootInput/Chib/chic_SelEvts_Output_Step5.root' ]
    inputfiles = [ 'file:/scratch/knuenz/Polarization/RootInput/Chib/chibstep5_05Apri112_B005.root', 'file:/scratch/knuenz/Polarization/RootInput/Chib/chibstep5_05Apri112_B006.root' ]

#    inputfiles = ['file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_A.root', 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_A001.root', 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_A002.root', 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_A003.root', 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_A004.root', 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_A005.root', 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_A006.root', 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_B.root', 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_B001.root',  'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_B002.root', 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_B003.root', 'file:/scratch/knuenz/Polarization/RootInput/Chib/chicstep5_B004.root']
